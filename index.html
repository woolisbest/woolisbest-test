<head>
  ...
  <script>
    window.dataLayer = window.dataLayer || []; function gtag() { dataLayer.push(arguments); } gtag('js', new Date()); gtag('config', 'G-NCTSG4T1B6');
  </script>
  ...
  <script defer="" data-domain="phantom.lol" src="https://stats.senty.com.au/js/script.outbound-links.pageview-props.tagged-events.js"></script>
  <style>
    .pp-banner-partner {
        position: fixed;
...
<body>
  ...
  <script type="module" async="">
    import { SettingsManager } from "/assets/js/settings_manager.js" import { changeTheme } from "/assets/js/themes.js" window.changeTheme = changeTheme; window.settings = new SettingsManager(); window.settings.default( "search-engine", "https://duckduckgo.com/?q=%s",
    ); document.getElementById("uv-search-engine").value = await window.settings.get("search-engine");
  </script>
